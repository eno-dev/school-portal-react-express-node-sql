                    ...
                    <div className={Style.container} key={obj.id}>
                        ...
                        <div className={Style.objectContainer}>
                            <object data={`${process.env.REACT_APP_URL}${data.data[0].attributes.Material.data[0].attributes.url}`}
                                ...
                                <p>Alternative text - include a link {checkFileExt(data.data[1].attributes.Material.data[0].attributes.ext)}<a href={`${process.env.REACT_APP_URL}${data.data[1].attributes.Material.data[0].attributes.url}`} target='_blank' rel="noreferrer">to the PDF!</a></p>
                            </object>
                        </div>
                    </div>
