...
const Navbar = () => {
  ...
  const data = [
    ...
    {
      id: 2,
      menuHeading: 'News & Events',
      links: [
        { id: 1, heading: 'Competitions', link: 'competitions' },
        { id: 2, heading: 'Gallery', link: 'gallery' },
      ],
    },
    {
      id: 3,
      menuHeading: 'Students Section',
      links: [
        { id: 1, heading: 'Schedule', link: 'students/schedule' },
        {
          id: 2,
          heading: 'Study Material',
          link: 'students/study-material',
        },
      ],
    },
    {
                ...
                {data &&
                  data.map(obj => (
                    <div className={Style.dropdownContainer} key={obj.id}>
                      <div className={Style.menuHeading}>{obj.menuHeading}</div>
            ...
            <div className={Style.menu}>
              <div className={Style.menuLinks}>
                <div className={Style.dropdownContainer}>
                  <div className={Style.menuHeading}>About Us</div>
                  <div className={Style.dropdownContent}>
                    <NavLinks link={'about-us'} heading={'About Us'} />
                  </div>
                </div>
                <div className={Style.dropdownContainer}>
                  <div className={Style.menuHeading}>News & Events</div>
                  <div className={Style.dropdownContent}>
                ...
                <div className={Style.dropdownContainer}>
                  <div className={Style.menuHeading}>
                    <Link to="students">Students Section</Link>
                  </div>
                  <div className={Style.dropdownContent}>
                    <Link to="students/schedule">Schedule</Link>
                    <Link to="students/study-material">Study Material</Link>
                  </div>
                </div>
                <div className={Style.dropdownContainer}>
                  <div className={Style.menuHeading}>
                    <Link to="parents-carers">Parents Section</Link>
                  </div>
                </div>
                {isLoggedInState ? (
                  <div className={Style.menuHeading}>
